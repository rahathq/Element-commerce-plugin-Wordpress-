...
final class ECMA_Addons_Admin {
	...
	public function render_dashboard_page() {
		...
		$total_widgets  = 4;
		$active_count   = 0;
		$available_ids  = [ 'product-gallery-slider', 'before-after-slider', 'dynamic-data-table', 'recently-viewed-products' ];
	...
	public function render_widgets_manager_page() {
		...
		$recent_active       = ( $active_widgets['recently-viewed-products'] ?? 'yes' ) === 'yes';
		?>
		<div class="ecma-admin-wrap">
			...
			<div class="ecma-widgets-grid">
				...
				<div class="ecma-widget-card">
					...
					<div class="ecma-widget-info">
						<h3><?php esc_html_e( 'Data Table', 'e-com-addons' ); ?></h3>
						<p><?php esc_html_e( 'Highly customizable, responsive comparison and specifications tables featuring live search, column sorting, custom badges, and button links.', 'e-com-addons' ); ?></p>
					</div>
					<div class="ecma-widget-toggle-area">
						<label class="ecma-switch">
				...
				<div class="ecma-widget-card">
					...
					<div class="ecma-widget-info">
						<h3><?php esc_html_e( 'Recently Viewed Products', 'e-com-addons' ); ?></h3>
						<p><?php esc_html_e( 'Displays products that a visitor has recently viewed on the website. Features responsive Grid/Carousel layout, AJAX rendering for cache-friendliness, and WooCommerce compatibility.', 'e-com-addons' ); ?></p>
					</div>
					<div class="ecma-widget-toggle-area">
						<label class="ecma-switch">
							<input type="checkbox" class="ecma-widget-toggle" data-widget-id="recently-viewed-products" <?php checked( $recent_active ); ?>>
							<span class="ecma-switch-slider"></span>
						</label>
					</div>
				</div>
